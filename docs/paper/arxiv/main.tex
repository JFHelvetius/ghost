...
property. The contribution is the assembly of the seven boxes into
one shippable unit; the property set, the closed-form bound, and the
TLA+ specs instantiate the pattern on a representative supervisor.}
\label{fig:pattern}
\end{figure}
...
published feature sets (RTAMT 0.3.5 from PyPI; Ghost v0.2.2). This
framing is what a reader can defend without entering an arms race
about which STL encoding ``really'' represents BAUD-v1.
