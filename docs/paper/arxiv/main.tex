...
\caption{Comparison of Project Ghost with the closest runtime
         verification and supervisory-control tooling. To the best
         of our knowledge, and within the scope of the literature
         review documented in this section, no prior tool ships a
         content-addressed, pure-function safety-property verifier
         via \texttt{pip install} with mechanically verified
         underlying invariants; we welcome correction from readers
         with broader coverage of the surveyed fields.}
