...
TLA+ spec \texttt{Rlb.tla} mechanises; it is an auxiliary result,
not a contribution. We position the work as a \textbf{systems /
tools paper, not a theory paper}; readers should grade
C1--C3. Figure~\ref{fig:pattern} summarises the pattern.
