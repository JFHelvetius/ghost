...
single command.} The pattern composes seven existing ingredients ---
...
\texttt{pip install} with mechanically verified invariants. Welcome
correction from readers with broader coverage.}
...
(\S\ref{app:theorem}). This is an auxiliary structural result that
\texttt{Rlb.tla} mechanises, not a contribution.
