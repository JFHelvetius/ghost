...
\begin{itemize}[noitemsep,topsep=2pt]
  ...
  \item \textbf{ERUR-v1 / v2.} \emph{When evidence is restored,
        ...
        criterion. v0.2.3 ships v1; v2 is hand-evaluated for the
        three calibrators of Appendix~\ref{app:eval}, Table
        \ref{tab:policy-comparison} (ADR-0040 lifts v2 to a
        generic verifier in v0.2.4).
