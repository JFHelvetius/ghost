...
citation}. Two properties (BAUD-v1, ERUR-v1) plus the recovery
latency bound and the FPB counter automaton are mechanically
verified by TLA+/TLC; the whole pipeline runs end-to-end on a real
PX4 flight log in CI.
