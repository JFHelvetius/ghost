------------------------------- MODULE Rlb -------------------------------
(****************************************************************************)
(* TLA+ specification of Theorem 1 (RLB-v1) from ADR-0034 / paper §6.        *)
(*                                                                          *)
(* MODEL: Theorem 1's statement is conditional on a *transient drift        *)
...
(* is the mechanical witness of Theorem 1 within its stated hypotheses.    *)
(*                                                                          *)
...
(* paper's Theorem 1 explicitly states the consecutive-drift hypothesis.    *)
